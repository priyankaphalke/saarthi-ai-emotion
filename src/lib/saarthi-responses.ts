...
const topicKeywords: Record<string, string[]> = {
  ...
  "Database": ["database", "sql", "query", "table", "join", "normalization", "dbms"],
  "Operating System": ["os", "operating system", "process", "thread", "deadlock", "scheduling", "memory management", "paging"],
  "Networking": ["network", "tcp", "http", "ip", "protocol", "osi", "dns", "router", "subnet"],
  "Dynamic Programming": ["dynamic programming", "dp", "memoization", "tabulation", "overlapping"],
  "Machine Learning": ["ml", "machine learning", "neural", "ai", "model", "training", "deep learning", "regression", "classification"],
  "Physics": ["physics", "newton", "force", "velocity", "acceleration", "momentum", "gravity", "wave", "optics", "thermodynamics", "energy", "electric", "magnetic", "quantum"],
  "Chemistry": ["chemistry", "atom", "molecule", "reaction", "bond", "electron", "proton", "neutron", "acid", "base", "oxidation", "reduction", "organic", "inorganic", "periodic table", "valence"],
  "Mathematics": ["math", "calculus", "integral", "derivative", "matrix", "algebra", "probability", "statistics", "geometry", "trigonometry", "logarithm", "limit", "differential equation", "vector"],
  "Biology": ["biology", "cell", "dna", "rna", "gene", "evolution", "photosynthesis", "mitosis", "meiosis", "protein", "enzyme", "chromosome", "ecology", "organism"],
  "Nanotechnology": ["nanotechnology", "nano", "nanoparticle", "nanomaterial", "nanoscale", "carbon nanotube", "quantum dot"],
  "Engineering": ["engineering", "circuit", "signal", "control system", "thermodynamic", "mechanics", "fluid", "structural", "semiconductor"],
  "General": [],
};
